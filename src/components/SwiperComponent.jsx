...
// const SwiperComponent = () => {  // Komponent nomini o'zgartirdim
//     return (
//         <div >
//              <Swiper
//         slidesPerView={1}
...
//         <SwiperSlide><img className='w-full h-[500px]' src={img4} alt="" /></SwiperSlide>
//         <SwiperSlide><img className='w-full h-[500px]' src={img6} alt="" /></SwiperSlide>
//       </Swiper>
//         </div>
//     );
// }

// export default SwiperComponent;  // Export nomini ham o'zgartirdim
